 ...
 */ var __webpack_modules__ = {
  ...
  7628: (module, __unused_webpack_exports, __webpack_require__) => {
    var lengthOfArrayLike = __webpack_require__(6198);
  ...
  1767: (module) => {
    module.exports = function (obj) {
      return { iterator: obj, next: obj.next, done: false };
    };
  },
  ...
  4979: (
    ...
    var $DOMException = function DOMException() {
      ...
      var message = normalizeStringArgument(
        argumentsLength < 1 ? undefined : arguments[0],
      );
      var name = normalizeStringArgument(
        argumentsLength < 2 ? undefined : arguments[1],
        "Error",
      );
      ...
      defineProperty(
        that,
        "stack",
        createPropertyDescriptor(1, clearErrorStack(error.stack, 1)),
      );
      inheritIfRequired(that, this, $DOMException);
      return that;
    };
    var DOMExceptionPrototype = ($DOMException.prototype =
      NativeDOMException.prototype);
    var ERROR_HAS_STACK = "stack" in new Error(DOM_EXCEPTION);
    var DOM_EXCEPTION_HAS_STACK = "stack" in new NativeDOMException(1, 2);
    var descriptor =
      NativeDOMException &&
      DESCRIPTORS &&
      Object.getOwnPropertyDescriptor(globalThis, DOM_EXCEPTION);
    var BUGGY_DESCRIPTOR =
      !!descriptor && !(descriptor.writable && descriptor.configurable);
    var FORCED_CONSTRUCTOR =
      ERROR_HAS_STACK && !BUGGY_DESCRIPTOR && !DOM_EXCEPTION_HAS_STACK;
    $(
      {
        global: true,
        constructor: true,
    ...
    if (
      PolyfilledDOMExceptionPrototype.constructor !== PolyfilledDOMException
    ) {
      if (!IS_PURE) {
        defineProperty(
          PolyfilledDOMExceptionPrototype,
          "constructor",
          createPropertyDescriptor(1, PolyfilledDOMException),
        );
      }
        ...
        if (hasOwn(DOMExceptionConstants, key)) {
          ...
          if (!hasOwn(PolyfilledDOMException, constantName)) {
            defineProperty(
              ...
              constantName,
              createPropertyDescriptor(6, constant.c),
            );
          }
        }
    }
...
const TextLayerMode = { DISABLE: 0, ENABLE: 1, ENABLE_PERMISSIONS: 2 };
const ScrollMode = {
  UNKNOWN: -1,
  VERTICAL: 0,
  HORIZONTAL: 1,
...
function getPageSizeInches({ view: view, userUnit: userUnit, rotate: rotate }) {
...
function getVisibleElements({
  scrollEl: scrollEl,
  views: views,
  sortByVisibility: sortByVisibility = false,
  ...
  return { first: first, last: last, views: visible, ids: ids };
}
...
function apiPageLayoutToViewerModes(layout) {
  ...
  return { scrollMode: scrollMode, spreadMode: spreadMode };
}
...
const Type = { BOOLEAN: 1, NUMBER: 2, OBJECT: 4, STRING: 8, UNDEFINED: 16 };
const defaultOptions = {
  allowedGlobalEvents: { value: null, kind: OptionKind.BROWSER },
  canvasMaxAreaInBytes: {
    value: -1,
    kind: OptionKind.BROWSER + OptionKind.API,
  },
  isInAutomation: { value: false, kind: OptionKind.BROWSER },
  localeProperties: {
    value: { lang: navigator.language || "en-US" },
    kind: OptionKind.BROWSER,
  },
  nimbusDataStr: { value: "", kind: OptionKind.BROWSER },
  supportsCaretBrowsingMode: { value: false, kind: OptionKind.BROWSER },
  supportsDocumentFonts: { value: true, kind: OptionKind.BROWSER },
  supportsIntegratedFind: { value: false, kind: OptionKind.BROWSER },
  supportsMouseWheelZoomCtrlKey: { value: true, kind: OptionKind.BROWSER },
  supportsMouseWheelZoomMetaKey: { value: true, kind: OptionKind.BROWSER },
  supportsPinchToZoom: { value: true, kind: OptionKind.BROWSER },
  toolbarDensity: {
    value: 0,
  ...
  annotationMode: { value: 2, kind: OptionKind.VIEWER + OptionKind.PREFERENCE },
  cursorToolOnLoad: {
    value: 0,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  debuggerSrc: { value: "./debugger.mjs", kind: OptionKind.VIEWER },
  defaultZoomDelay: {
    value: 400,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  ...
  disableHistory: { value: false, kind: OptionKind.VIEWER },
  disablePageLabels: {
    value: false,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  ...
  imageResourcesPath: { value: "./images/", kind: OptionKind.VIEWER },
  maxCanvasPixels: { value: 2 ** 25, kind: OptionKind.VIEWER },
  forcePageColors: {
    value: false,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  ...
  printResolution: { value: 150, kind: OptionKind.VIEWER },
  sidebarViewOnLoad: {
    value: -1,
    kind: OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  ...
  textLayerMode: { value: 1, kind: OptionKind.VIEWER + OptionKind.PREFERENCE },
  viewOnLoad: { value: 0, kind: OptionKind.VIEWER + OptionKind.PREFERENCE },
  cMapPacked: { value: true, kind: OptionKind.API },
  cMapUrl: { value: "../web/cmaps/", kind: OptionKind.API },
  disableAutoFetch: {
    value: false,
  ...
  disableRange: { value: false, kind: OptionKind.API + OptionKind.PREFERENCE },
  disableStream: { value: false, kind: OptionKind.API + OptionKind.PREFERENCE },
  docBaseUrl: { value: "", kind: OptionKind.API },
  enableHWA: {
    value: true,
    kind: OptionKind.API + OptionKind.VIEWER + OptionKind.PREFERENCE,
  },
  enableXfa: { value: true, kind: OptionKind.API + OptionKind.PREFERENCE },
  fontExtraProperties: { value: false, kind: OptionKind.API },
  isEvalSupported: { value: true, kind: OptionKind.API },
  isOffscreenCanvasSupported: { value: true, kind: OptionKind.API },
  maxImageSize: { value: -1, kind: OptionKind.API },
  pdfBug: { value: false, kind: OptionKind.API },
  standardFontDataUrl: {
  ...
  verbosity: { value: 1, kind: OptionKind.API },
  workerPort: { value: null, kind: OptionKind.WORKER },
  workerSrc: { value: "../build/pdf.worker.mjs", kind: OptionKind.WORKER },
};
{
  ...
  defaultOptions.enableFakeMLManager = { value: true, kind: OptionKind.VIEWER };
}
{
  defaultOptions.disablePreferences = { value: false, kind: OptionKind.VIEWER };
}
class AppOptions {
  static eventBus;
  static #opts = new Map();
...
const LinkTarget = { NONE: 0, SELF: 1, BLANK: 2, PARENT: 3, TOP: 4 };
class PDFLinkService {
  ...
  constructor({
    ...
    ignoreDestinationZoom: ignoreDestinationZoom = false,
  } = {}) {
...
async function waitOnEventOrTimeout({
  ...
  const { promise: promise, resolve: resolve } = Promise.withResolvers();
...
class BasePreferences {
  ...
  constructor() {
    this.#initializedPromise = this._readFromStorage(this.#defaults).then(
      ({ browserPrefs: browserPrefs, prefs: prefs }) => {
        if (AppOptions._checkDisablePreferences()) {
          return;
        }
        AppOptions.setAll({ ...browserPrefs, ...prefs }, true);
      },
    );
  }
  ...
  async set(name, value) {
    await this.#initializedPromise;
    AppOptions.setAll({ [name]: value }, true);
...
function resolveVariableReference(scope, { name: name }) {
  let arg;
  if (scope.params) {
...
function resolveMessageReference(scope, { name: name, attr: attr }) {
...
function resolveTermReference(scope, { name: name, attr: attr, args: args }) {
  const id = `-${name}`;
...
function resolveFunctionReference(scope, { name: name, args: args }) {
...
function resolveSelectExpression(
  scope,
  { selector: selector, variants: variants, star: star },
) {
...
class FluentBundle {
  constructor(
    ...
    {
      functions: functions,
      useIsolating: useIsolating = true,
    ...
    this._functions = { NUMBER: NUMBER, DATETIME: DATETIME, ...functions };
  ...
  addResource(res, { allowOverrides: allowOverrides = false } = {}) {
    const errors = [];
  ...
  constructor(source) {
    ...
    function parsePlaceable() {
      ...
      if (consumeToken(TOKEN_ARROW)) {
        ...
        return { type: "select", selector: selector, ...variants };
      }
    ...
    function parseVariantKey() {
      ...
      if (test(RE_NUMBER_LITERAL)) {
        ...
        key = { type: "str", value: match1(RE_IDENTIFIER) };
      }
    ...
    function parseNumberLiteral() {
      ...
      return { type: "num", value: parseFloat(value), precision: precision };
    }
...
class Localization {
  ...
  async formatValue(id, args) {
    const [val] = await this.formatValues([{ id: id, args: args }]);
    return val;
  }
  handleEvent() {
    this.onChange();
...
function messageFromBundle(bundle, errors, message, args) {
  const formatted = { value: null, attributes: null };
  if (message.value) {
  ...
  if (attrNames.length > 0) {
    ...
    for (let [i, name] of attrNames.entries()) {
      ...
      formatted.attributes[i] = { name: name, value: value };
    }
  }
  return formatted;
}
function keysFromBundle(method, bundle, keys, translations) {
  ...
  keys.forEach(({ id: id, args: args }, i) => {
...
class L10n {
  ...
  #lang;
  #l10n;
  constructor({ lang: lang, isRTL: isRTL }, l10n = null) {
  ...
  async get(ids, args = null, fallback) {
    ...
    const messages = await this.#l10n.formatMessages([{ id: ids, args: args }]);
...
class genericl10n_GenericL10n extends L10n {
  ...
  static async *#generateBundles(defaultLang, baseLang) {
    const { baseURL: baseURL, paths: paths } = await this.#getPaths();
  ...
  static async #getPaths() {
    try {
      const { href: href } = document.querySelector(
        `link[type="application/l10n"]`,
      );
      const paths = await fetchData(href, "json");
      return { baseURL: href.replace(/[^/]*$/, "") || "./", paths: paths };
    } catch {}
...
async function docProperties(pdfDocument) {
  ...
  if (!contentLength) {
    const { length: length } = await pdfDocument.getDownloadInfo();
...
class GenericScripting {
  constructor(sandboxBundleSrc) {
    this._ready = new Promise((resolve, reject) => {
      const sandbox = import(sandboxBundleSrc);
      sandbox
        .then((pdfjsSandbox) => {
...
class NewAltTextManager {
  ...
  constructor(
    {
      ...
      createAutomaticallyButton: createAutomaticallyButton,
      downloadModel: downloadModel,
      downloadModelDescription: downloadModelDescription,
      title: title,
    },
    overlayManager,
    eventBus,
    ...
    eventBus._on("enableguessalttext", ({ value: value }) => {
  ...
  #setProgress() {
    ...
    const callback = async ({
      detail: { finished: finished, total: total, totalLoaded: totalLoaded },
    }) => {
      ...
      const { mlManager: mlManager } = this.#uiManager;
  ...
  async editAltText(uiManager, editor, firstTime) {
    ...
    let { mlManager: mlManager } = uiManager;
    let hasAI = !!mlManager;
    this.#toggleTitleAndDisclaimer();
  ...
  #cancel() {
    this.#currentEditor.altTextData = { cancel: true };
  ...
  #save() {
    const altText = this.#textarea.value.trim();
    this.#currentEditor.altTextData = { altText: altText, decorative: false };
...
class ImageAltTextSettings {
  ...
  constructor(
    {
      ...
      downloadModelButton: downloadModelButton,
    ...
    const { altTextLearnMoreUrl: altTextLearnMoreUrl } = mlManager;
    if (altTextLearnMoreUrl) {
    ...
    eventBus._on("enablealttextmodeldownload", ({ value: value }) => {
      if (value) {
        this.#download(false);
      } else {
        this.#delete(false);
  ...
  async open({
    ...
    const { enableAltTextModelDownload: enableAltTextModelDownload } =
      this.#mlManager;
...
class AltTextManager {
  ...
  constructor(
    {
      ...
      optionDecorative: optionDecorative,
      textarea: textarea,
      cancelButton: cancelButton,
      saveButton: saveButton,
    },
  ...
  async editAltText(uiManager, editor) {
    ...
    const { altText: altText, decorative: decorative } = editor.altTextData;
    if (decorative === true) {
...
class AnnotationEditorParams {
  ...
  #bindListeners({
    ...
    editorHighlightShowAll: editorHighlightShowAll,
  }) {
...
class CaretBrowsingMode {
  ...
  #getCaretPosition(selection, isUp) {
    const { focusNode: focusNode, focusOffset: focusOffset } = selection;
  ...
  static #caretPositionFromPoint(x, y) {
    if (!document.caretPositionFromPoint) {
      ...
      return { offsetNode: offsetNode, offset: offset };
    }
  ...
  #setCaretPositionHelper(selection, caretX, select, element, rect) {
    ...
    if (rect.right - PRECISION <= caretX) {
      const { lastChild: lastChild } = element;
      if (select) {
  ...
  moveCaret(isUp, select) {
    ...
    const { focusNode: focusNode } = selection;
    const focusElement =
    ...
    if (!newLineElement) {
      ...
      const { parentElement: parentElement } = node;
...
class OverlayManager {
  ...
  async register(dialog, canForceClose = false) {
    ...
    this.#overlays.set(dialog, { canForceClose: canForceClose });
...
class PDFAttachmentViewer extends BaseTreeViewer {
  ...
  _bindLink(
    element,
    { content: content, description: description, filename: filename },
  ) {
    if (description) {
  ...
  render({
    ...
    keepRenderedCapability: keepRenderedCapability = false,
  }) {
  ...
  #appendAttachment(item) {
    ...
    renderedPromise.then(() => {
      ...
      this.render({ attachments: attachments, keepRenderedCapability: true });
    });
  }
}
...
class PDFCursorTools {
  ...
  constructor({
    container: container,
    eventBus: eventBus,
    cursorToolOnLoad: cursorToolOnLoad = CursorTool.SELECT,
  }) {
    this.container = container;
    this.eventBus = eventBus;
  ...
  #addEventListeners() {
    ...
    this.eventBus._on("annotationeditormodechanged", ({ mode: mode }) => {
    ...
    this.eventBus._on("presentationmodechanged", ({ state: state }) => {
...
class PDFDocumentProperties {
  #fieldData = null;
  constructor(
    { dialog: dialog, fields: fields, closeButton: closeButton },
    overlayManager,
    eventBus,
    l10n,
    fileNameLookup,
  ...
  async open() {
    ...
    const [{ info: info, contentLength: contentLength }, pdfPage] =
      await Promise.all([
    ...
    this.#updateUI();
    const { length: length } = await this.pdfDocument.getDownloadInfo();
  ...
  async #parsePageSize(pageSizeInches, pagesRotation) {
    ...
    const [{ width: width, height: height }, unit, name, orientation] =
      await Promise.all([
...
function isHan(charCode) {
  return (
    (charCode >= 13312 && charCode <= 40959) ||
    (charCode >= 63744 && charCode <= 64255)
  );
}
...
const DIACRITICS_EXCEPTION = new Set([
  ...
  3405, 3530, 3642, 3770, 3972, 4153, 4154, 5908, 5940, 6098, 6752, 6980, 7082,
  7083, 7154, 7155, 11647, 43014, 43052, 43204, 43347, 43456, 43766, 44013,
  3158, 3953, 3954, 3962, 3963, 3964, 3965, 3968, 3956,
]);
...
class PDFFindController {
  ...
  constructor({
    ...
    eventBus: eventBus,
    updateMatchesCountOnProgress: updateMatchesCountOnProgress = true,
  }) {
  ...
  #reset() {
    ...
    this._offset = { pageIdx: null, matchIdx: null, wrapped: false };
  ...
  #convertToRegExpString(query, hasDiacritics) {
    const { matchDiacritics: matchDiacritics } = this.#state;
    let isUnicode = false;
  ...
  #calculateMatch(pageIndex) {
    ...
    matcherResult?.forEach(({ index: index, length: length }) => {
  ...
  match(query, pageContent, pageIndex) {
    ...
    const { caseSensitive: caseSensitive, entireWord: entireWord } =
      this.#state;
  ...
  #requestMatchesCount() {
    const { pageIdx: pageIdx, matchIdx: matchIdx } = this._selected;
    let current = 0,
...
class PDFFindBar {
  ...
  constructor(options, mainContainer, eventBus) {
    ...
    this.bar.addEventListener(
      "keydown",
      ({ keyCode: keyCode, shiftKey: shiftKey, target: target }) => {
        switch (keyCode) {
          case 13:
  ...
  updateUIState(state, previous, matchesCount) {
    const { findField: findField, findMsg: findMsg } = this;
    let findMsgId = "",
      status = "";
    switch (state) {
  ...
  updateResultsCount({ current: current = 0, total: total = 0 } = {}) {
    const { findResultsCount: findResultsCount } = this;
    if (total > 0) {
      ...
      findResultsCount.setAttribute(
        "data-l10n-args",
        JSON.stringify({ limit: limit, current: current, total: total }),
      );
    } else {
...
class PDFHistory {
  ...
  initialize({
    ...
    resetHistory: resetHistory = false,
    ...
    if (!this.#isValidState(state, true) || resetHistory) {
      ...
      this.#pushOrReplaceState(
        { hash: hash, page: page, rotation: rotation },
        true,
      );
      return;
    }
  ...
  #parseCurrentHash(checkNameddest = false) {
    ...
    return { hash: hash, page: page, rotation: this.linkService.rotation };
  }
  #updateViewarea({ location: location }) {
    if (this._updateViewareaTimeout) {
      clearTimeout(this._updateViewareaTimeout);
      this._updateViewareaTimeout = null;
    }
  ...
  #bindEvents() {
    ...
    const { signal: signal } = this.#eventAbortController;
...
class PDFLayerViewer extends BaseTreeViewer {
  ...
  _bindLink(element, { groupId: groupId, input: input }) {
    const setVisibility = () => {
  ...
  _setNestedName(element, { name: name = null }) {
  ...
  _addToggleButton(div, { name: name = null }) {
  ...
  render({
    ...
    const fragment = document.createDocumentFragment(),
      queue = [{ parent: fragment, groups: groups }];
    let layersCount = 0,
      hasAnyNesting = false;
    while (queue.length > 0) {
      ...
      for (const groupId of levelData.groups) {
        ...
        if (typeof groupId === "object") {
          ...
          this._bindLink(element, { groupId: groupId, input: input });
          input.type = "checkbox";
...
class PDFOutlineViewer extends BaseTreeViewer {
  ...
  _bindLink(
    ...
    const { linkService: linkService } = this;
    if (url) {
  ...
  _setStyles(element, { bold: bold, italic: italic }) {
    if (bold) {
  ...
  _addToggleButton(div, { count: count, items: items }) {
    let hidden = false;
    if (count < 0) {
  ...
  render({ outline: outline, pdfDocument: pdfDocument }) {
    if (this._outline) {
      this.reset();
    }
  ...
  async _getPageNumberToDestHash(pdfDocument) {
    ...
    while (queue.length > 0) {
      ...
      for (const { dest: dest, items: items } of levelData.items) {
        ...
        if (items.length > 0) {
          queue.push({ nesting: currentNesting + 1, items: items });
        }
      }
    }
...
class PDFPresentationMode {
  ...
  async request() {
    const { container: container, pdfViewer: pdfViewer } = this;
  ...
  #addWindowListeners() {
    ...
    const { signal: signal } = this.#windowAbortController;
...
function getXfaHtmlForPrinting(printContainer, pdfDocument) {
  ...
  for (const xfaPage of xfaHtml.children) {
    ...
    const viewport = getXfaPageViewport(xfaPage, { scale: scale });
...
class PDFPrintService {
  constructor({
    ...
    printAnnotationStoragePromise: printAnnotationStoragePromise = null,
  }) {
    this.pdfDocument = pdfDocument;
  ...
  layout() {
    ...
    const { width: width, height: height } = this.pagesOverview[0];
...
class PDFScriptingManager {
  ...
  constructor({
    eventBus: eventBus,
    externalServices: externalServices = null,
  ...
  async setDocument(pdfDocument) {
    ...
    eventBus._on(
      "pagechanging",
      ({ pageNumber: pageNumber, previous: previous }) => {
    ...
    for (const elementId of ids) {
      ...
      if (element) {
        element.dispatchEvent(
          new CustomEvent("updatefromsandbox", { detail: detail }),
        );
      } else {
...
class PDFSidebar {
  ...
  #width = null;
  constructor({ elements: elements, eventBus: eventBus, l10n: l10n }) {
    this.isOpen = false;
  ...
  #addEventListeners() {
    const { eventBus: eventBus, outerContainer: outerContainer } = this;
...
class PDFThumbnailView {
  ...
  #updateDims() {
    const { width: width, height: height } = this.viewport;
    const ratio = width / height;
    this.canvasWidth = THUMBNAIL_WIDTH;
    this.canvasHeight = (this.canvasWidth / ratio) | 0;
    this.scale = this.canvasWidth / width;
    const { style: style } = this.div;
  ...
  #getPageDrawContext(upscaleFactor = 1, enableHWA = this.enableHWA) {
    ...
    const transform = outputScale.scaled
      ...
      : null;
    return { ctx: ctx, canvas: canvas, transform: transform };
  }
  ...
  #reduceImage(img) {
    const { ctx: ctx, canvas: canvas } = this.#getPageDrawContext(1, true);
...
class PDFThumbnailViewer {
  ...
  scrollThumbnailIntoView(pageNumber) {
    ...
    const { first: first, last: last, views: views } = this.#getVisibleThumbs();
    if (views.length > 0) {
      let shouldScroll = false;
      if (pageNumber <= first.id || pageNumber >= last.id) {
        shouldScroll = true;
      } else {
        for (const { id: id, percent: percent } of views) {
          if (id !== pageNumber) {
            continue;
          }
...
class AnnotationLayerBuilder {
  ...
  constructor({
    ...
    renderForms: renderForms = true,
    enableScripting: enableScripting = false,
    hasJSActionsPromise: hasJSActionsPromise = null,
    fieldObjectsPromise: fieldObjectsPromise = null,
    annotationCanvasMap: annotationCanvasMap = null,
    accessibilityManager: accessibilityManager = null,
    annotationEditorUIManager: annotationEditorUIManager = null,
    onAppend: onAppend = null,
  }) {
    this.pdfPage = pdfPage;
    this.linkService = linkService;
  ...
  async render(viewport, options, intent = "display") {
    ...
    let [annotations, hasJSActions, fieldObjects] = await Promise.all([
      this.pdfPage.getAnnotations({ intent: intent }),
    ...
    annotations = annotations.filter(
      (x) =>
        allowedSubtypes.includes(x.subtype) ||
...
class StructTreeLayerBuilder {
  ...
  #setAttributes(structElement, htmlElement) {
    const { alt: alt, id: id, lang: lang } = structElement;
    if (alt !== undefined) {
      let added = false;
  ...
  #addImageInTextLayer(node, element) {
    const { alt: alt, bbox: bbox, children: children } = node;
...
class TextHighlighter {
  ...
  _convertMatches(matches, matchesLength) {
    ...
    const { textContentItemsStr: textContentItemsStr } = this;
    let i = 0,
      iIndex = 0;
    ...
    for (let m = 0, mm = matches.length; m < mm; m++) {
      ...
      const match = { begin: { divIdx: i, offset: matchIdx - iIndex } };
  ...
  _renderMatches(matches) {
    ...
    const { findController: findController, pageIdx: pageIdx } = this;
    const { textContentItemsStr: textContentItemsStr, textDivs: textDivs } =
      this;
    ...
    function appendTextToDiv(divIdx, fromOffset, toOffset, className) {
      ...
      if (className) {
        ...
        if (className.includes("selected")) {
          const { left: left } = span.getClientRects()[0];
...
class TextLayerBuilder {
  ...
  constructor({
    ...
    accessibilityManager: accessibilityManager = null,
    enablePermissions: enablePermissions = false,
    onAppend: onAppend = null,
  }) {
    this.pdfPage = pdfPage;
  ...
  async render(viewport, textContentParams = null) {
    ...
    const { textDivs: textDivs, textContentItemsStr: textContentItemsStr } =
      this.#textLayer;
  ...
  static #enableGlobalSelectionListener() {
    ...
    const { signal: signal } = this.#selectionChangeAbortController;
...
class PDFPageView {
  ...
  constructor(options) {
    ...
    if (this._isStandalone) {
      ...
      const { optionalContentConfigPromise: optionalContentConfigPromise } =
        options;
  ...
  reset({
    keepAnnotationLayer: keepAnnotationLayer = false,
    keepAnnotationEditorLayer: keepAnnotationEditorLayer = false,
    keepXfaLayer: keepXfaLayer = false,
    keepTextLayer: keepTextLayer = false,
    keepCanvasWrapper: keepCanvasWrapper = false,
  } = {}) {
    this.cancelRendering({
      keepAnnotationLayer: keepAnnotationLayer,
      keepAnnotationEditorLayer: keepAnnotationEditorLayer,
      keepXfaLayer: keepXfaLayer,
      keepTextLayer: keepTextLayer,
    });
    this.renderingState = RenderingStates.INITIAL;
    const div = this.div;
    ...
    if (this.canvas) {
      ...
      if (this.#hasRestrictedScaling) {
        if (this.maxCanvasPixels === 0) {
          ...
          const { width: width, height: height } = this.viewport;
          const { sx: sx, sy: sy } = this.outputScale;
          onlyCssZoom =
  ...
  cancelRendering({
    ...
    keepXfaLayer: keepXfaLayer = false,
    keepTextLayer: keepTextLayer = false,
    cancelExtraDelay: cancelExtraDelay = 0,
  } = {}) {
    if (this.renderTask) {
  ...
  cssTransform({
    redrawAnnotationLayer: redrawAnnotationLayer = false,
    redrawAnnotationEditorLayer: redrawAnnotationEditorLayer = false,
    redrawXfaLayer: redrawXfaLayer = false,
    redrawTextLayer: redrawTextLayer = false,
    hideTextLayer: hideTextLayer = false,
  }) {
    const { canvas: canvas } = this;
    if (!canvas) {
      return;
  ...
  async draw() {
    ...
    const resultPromise = renderTask.promise.then(
      async () => {
        ...
        const { annotationEditorUIManager: annotationEditorUIManager } =
          this.#layerProperties;
  ...
  get thumbnailCanvas() {
    const {
      ...
      initialOptionalContent: initialOptionalContent,
      regularAnnotations: regularAnnotations,
...
class PDFViewer {
  ...
  constructor(options) {
    ...
    const { abortSignal: abortSignal } = options;
    abortSignal?.addEventListener(
      "abort",
      () => {
        this.#resizeObserver.disconnect();
    ...
    this.eventBus._on(
      "thumbnailrendered",
      ({ pageNumber: pageNumber, pdfPage: pdfPage }) => {
  ...
  set pagesRotation(rotation) {
    ...
    this.refresh(true, { rotation: rotation });
  ...
  async getAllText() {
    ...
    for (
      ...
      const { items: items } = await page.getTextContent();
  ...
  #copyCallback(textLayerMode, event) {
    const selection = document.getSelection();
    const { focusNode: focusNode, anchorNode: anchorNode } = selection;
    if (
      anchorNode &&
      focusNode &&
      ...
      const { classList: classList } = this.viewer;
  ...
  setDocument(pdfDocument) {
    ...
    const permissionsPromise = this.#enablePermissions
      ...
      : Promise.resolve();
    const { eventBus: eventBus, pageColors: pageColors, viewer: viewer } = this;
    this.#eventAbortController = new AbortController();
    const { signal: signal } = this.#eventAbortController;
    if (pagesCount > PagesCountLimit.FORCE_SCROLL_MODE_PAGE) {
      ...
      eventBus.dispatch("scrollmodechanged", { source: this, mode: mode });
    }
    ...
    eventBus._on("pagerendered", onAfterDraw, { signal: signal });
    Promise.all([firstPagePromise, permissionsPromise])
      .then(([firstPdfPage, permissions]) => {
        ...
        pdfDocument.getMetadata().then(({ info: info }) => {
          if (pdfDocument !== this.pdfDocument) {
            return;
          }
          if (info.Language) {
  ...
  #scrollIntoView(pageView, pageSpot = null) {
    ...
    if (!pageSpot && !this.isInPresentationMode) {
      ...
      const { scrollLeft: scrollLeft, clientWidth: clientWidth } =
        this.container;
      if (
  ...
  scrollPageIntoView({
    ...
    allowNegativeOffset: allowNegativeOffset = false,
    ignoreDestinationZoom: ignoreDestinationZoom = false,
  }) {
    if (!this.pdfDocument) {
      return;
    ...
    this.#scrollIntoView(pageView, { left: left, top: top });
  }
  _updateLocation(firstPage) {
    ...
    const normalizedScaleValue =
      parseFloat(currentScaleValue) === currentScale
        ? Math.round(currentScale * 1e4) / 100
        : currentScaleValue;
  ...
  #switchToEditAnnotationMode() {
    ...
    const { ids: ids, views: views } = visible;
  ...
  set scrollMode(mode) {
    ...
    this.eventBus.dispatch("scrollmodechanged", { source: this, mode: mode });
  ...
  set spreadMode(mode) {
    ...
    this.eventBus.dispatch("spreadmodechanged", { source: this, mode: mode });
  ...
  _getPageAdvance(currentPageNumber, previous = false) {
    switch (this._scrollMode) {
      case ScrollMode.WRAPPED: {
        const { views: views } = this._getVisiblePages(),
          pageLayout = new Map();
        for (const {
          id: id,
          y: y,
  ...
  set annotationEditorMode({
    mode: mode,
    editId: editId = null,
    isFromKeyboard: isFromKeyboard = false,
  }) {
    if (!this.#annotationEditorUIManager) {
...
class SecondaryToolbar {
  ...
  #updateUIState() {
    const {
      ...
      pageRotateCwButton: pageRotateCwButton,
      pageRotateCcwButton: pageRotateCcwButton,
    } = this.#opts;
  ...
  #bindListeners(buttons) {
    const { eventBus: eventBus } = this;
    const { toggleButton: toggleButton } = this.#opts;
    ...
    for (const {
      ...
      element.addEventListener("click", (evt) => {
        ...
        eventBus.dispatch("reporttelemetry", {
          source: this,
          details: { type: "buttons", data: { id: element.id } },
        });
      });
    }
  ...
  #cursorToolChanged({ tool: tool, disabled: disabled }) {
    const {
      cursorSelectToolButton: cursorSelectToolButton,
      cursorHandToolButton: cursorHandToolButton,
    } = this.#opts;
  ...
  open() {
    ...
    this.opened = true;
    const { toggleButton: toggleButton, toolbar: toolbar } = this.#opts;
...
class Toolbar {
  ...
  constructor(options, eventBus, toolbarDensity = 0) {
    ...
    const buttons = [
      ...
      { element: options.download, eventName: "download" },
      {
        ...
        eventDetails: {
          get mode() {
            const { classList: classList } = options.editorFreeTextButton;
      ...
      },
      {
        ...
        eventDetails: {
          get mode() {
            const { classList: classList } = options.editorHighlightButton;
            return classList.contains("toggled")
              ? AnnotationEditorType.NONE
      ...
      },
      {
        ...
        eventDetails: {
          get mode() {
            const { classList: classList } = options.editorInkButton;
            return classList.contains("toggled")
              ? AnnotationEditorType.NONE
      ...
      },
      {
        ...
        eventDetails: {
          get mode() {
            const { classList: classList } = options.editorStampButton;
            return classList.contains("toggled")
              ? AnnotationEditorType.NONE
  ...
  #updateToolbarDensity({ value: value }) {
    let name = "normal";
    switch (value) {
      case 1:
        name = "compact";
  ...
  #setAnnotationEditorUIManager(uiManager, parentContainer) {
    const colorPicker = new ColorPicker({ uiManager: uiManager });
  ...
  #bindListeners(buttons) {
    ...
    scaleSelect.addEventListener("click", function ({ target: target }) {
      if (
    ...
    eventBus._on("showannotationeditorui", ({ mode: mode }) => {
      switch (mode) {
  ...
  #updateUIState(resetNumPages = false) {
    ...
    if (resetNumPages) {
      if (this.hasPageLabels) {
        ...
        opts.numPages.setAttribute(
          "data-l10n-args",
          JSON.stringify({ pagesCount: pagesCount }),
        );
      }
    ...
    if (this.hasPageLabels) {
      ...
      opts.numPages.setAttribute(
        "data-l10n-args",
        JSON.stringify({ pageNumber: pageNumber, pagesCount: pagesCount }),
      );
    } else {
    ...
    if (!predefinedValueFound) {
      ...
      opts.customScaleOption.setAttribute(
        "data-l10n-args",
        JSON.stringify({ scale: Math.round(pageScale * 1e4) / 100 }),
      );
    }
  }
  updateLoadingIndicatorState(loading = false) {
    const { pageNumber: pageNumber } = this.#opts;
...
const IDENTITY_MATRIX = null && [1, 0, 0, 1, 0, 0];
const FONT_IDENTITY_MATRIX = null && [0.001, 0, 0, 0.001, 0, 0];
...
const util_ImageKind = { GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3 };
...
const PageActionEventType = { O: "PageOpen", C: "PageClose" };
const util_VerbosityLevel = { ERRORS: 0, WARNINGS: 1, INFOS: 5 };
const util_OPS = {
  dependency: 1,
  setLineWidth: 2,
  setLineCap: 3,
...
const util_PasswordResponses = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
...
const PDFStringTranslateTable = null && [
...
const ViewOnLoad = { UNKNOWN: -1, PREVIOUS: 0, INITIAL: 1 };
const PDFViewerApplication = {
  initialBookmark: document.location.hash.substring(1),
  _initializedCapability: { ...Promise.withResolvers(), settled: false },
  appConfig: null,
  pdfDocument: null,
  pdfLoadingTask: null,
  printService: null,
  ...
  async _parseHashParams() {
    ...
    const { mainContainer: mainContainer, viewerContainer: viewerContainer } =
        this.appConfig,
    ...
    const loadPDFBug = async () => {
      ...
      const { PDFBug: PDFBug } = await import(AppOptions.get("debuggerSrc"));
      this._PDFBug = PDFBug;
    };
    if (params.get("disableworker") === "true") {
      try {
        GlobalWorkerOptions.workerSrc ||= AppOptions.get("workerSrc");
        await import(PDFWorker.workerSrc);
      } catch (ex) {
  ...
  async _initializeViewerComponents() {
    ...
    const pdfViewer = new PDFViewer({
      ...
      annotationMode: util_AnnotationMode.DISABLE,
      annotationEditorMode: annotationEditorMode,
  ...
  async run(config) {
    ...
    const { appConfig: appConfig, eventBus: eventBus } = this;
    let file;
  ...
  _hideViewBookmark() {
    const { secondaryToolbar: secondaryToolbar } = this.appConfig;
  ...
  async open(args) {
    ...
    const loadingTask = getDocument({ ...apiParams, ...args });
    this.pdfLoadingTask = loadingTask;
    loadingTask.onPassword =
      this.onPassword ||
      ((updateCallback, reason) => {
        if (this.isViewerEmbedded) {
          this._unblockDocumentLoadEvent();
        }
    ...
    loadingTask.onProgress = ({ loaded: loaded, total: total }) => {
  ...
  async downloadOrSave() {
    const { classList: classList } = this.appConfig.appContainer;
    classList.add("wait");
  ...
  load(pdfDocument) {
    this.pdfDocument = pdfDocument;
    pdfDocument.getDownloadInfo().then(({ length: length }) => {
    ...
    onePageRendered.then((data) => {
      ...
      if (this.pdfAttachmentViewer) {
        pdfDocument.getAttachments().then((attachments) => {
          ...
          this.pdfAttachmentViewer.render({ attachments: attachments });
        });
      }
  ...
  _initializeAnnotationStorageCallbacks(pdfDocument) {
    ...
    const { annotationStorage: annotationStorage } = pdfDocument;
  ...
  bindWindowEvents() {
    ...
    const {
      eventBus: eventBus,
      appConfig: { mainContainer: mainContainer },
      pdfViewer: pdfViewer,
      _windowAbortController: { signal: signal },
    } = this;
    ...
    const scroll = () => {
      ...
      mainContainer.addEventListener("blur", scrollend, { signal: signal });
    };
    mainContainer.addEventListener("scroll", scroll, {
      passive: true,
      signal: signal,
...
}
{
  ...
  var onFileInputChange = function (evt) {
    ...
    this.open({ url: URL.createObjectURL(file), originalUrl: file.name });
  };
  var onOpenFile = function (evt) {
    this._openFileInput?.click();
  };
}
function onPageRender({ pageNumber: pageNumber }) {
  if (pageNumber === this.page) {
    this.toolbar?.updateLoadingIndicatorState(true);
  }
}
function onPageRendered({ pageNumber: pageNumber, error: error }) {
  if (pageNumber === this.page) {
...
function onSidebarViewChanged({ view: view }) {
  this.pdfRenderingQueue.isThumbnailViewEnabled = view === SidebarView.THUMBS;
  if (this.isInitialViewSet) {
    this.store?.set("sidebarView", view).catch(() => {});
  }
}
function onUpdateViewarea({ location: location }) {
  if (this.isInitialViewSet) {
    this.store
      ?.setMultiple({
...
function onPageNumberChanged(evt) {
  const { pdfViewer: pdfViewer } = this;
  if (evt.value !== "") {
...
function onUpdateFindMatchesCount({ matchesCount: matchesCount }) {
  if (this.supportsIntegratedFind) {
...
function onPageChanging({ pageNumber: pageNumber, pageLabel: pageLabel }) {
...
function onKeyDown(evt) {
  ...
  const { eventBus: eventBus, pdfViewer: pdfViewer } = this;
  ...
  if (cmd === 1 || cmd === 8 || cmd === 5 || cmd === 12) {
    switch (evt.keyCode) {
      ...
      case 71:
        if (!this.supportsIntegratedFind) {
          const { state: state } = this.findController;
          if (state) {
            const newState = {
              source: window,
              type: "again",
