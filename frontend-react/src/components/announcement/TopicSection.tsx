      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1" style={{ minHeight: '32px' }}>
          ...
          <button
            ...
            className={
              (topicHovered ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none") +
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2 pl-2">
                    ...
                    <div className="flex items-center gap-1 self-start" style={{ minHeight: '32px' }}>
                      {/* PDF 위치 찾기 */}
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                        ...
                        className={
                          (contentHovered[index] ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none") +
